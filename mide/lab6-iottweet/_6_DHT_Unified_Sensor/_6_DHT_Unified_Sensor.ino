...
#define DHTPIN            2         // Pin which is connected to the DHT sensor. ให้ขา data เข้า pin 2
...
const char *userid = "000993";            //IoTtweet account user ID (6 digits, included zero pre-fix)
const char *key = "acta55m222d6";     //IoTtweet registered device key in "MY IOT Garage"
...
void setup() {
  Serial.begin(9600); //ให้เริ่มแสดงที่จอเราเอง
  // Initialize device.
  dht.begin();
